        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            <p className="font-['Jost'] text-sm text-[#DCD7CD] leading-relaxed opacity-70 max-w-xs">
              A tranquil retreat amidst nature, blending Kerala's traditional
              charm with modern comfort. Experience serenity at Vihara - The
              Courtyard.
            </p>
          </div>
          ...
          {/* Quick Links */}
          <div>
            <p className="font-['Jost'] text-xs tracking-[0.2em] uppercase text-[#D9B59D] mb-5">
              Quick Links
            </p>
